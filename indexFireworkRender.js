...
// var newYearDate = new Date('2024-02-20 09:15:00') /* develope date */
var newYearTimestampSeconds = newYearDate.getTime()/1000
var lastCountDown = -1
const boomAudio = new Audio(currentWorkPath + '/resources/boom_firework.mp3')
const yeahAudio = new Audio(currentWorkPath + '/resources/yeah.mp3')
yeahAudio.onended = ()=>{
    bgmAudio.volume = 1
    yeahAudioDone = true
}
var yeahAudioDone = false
...
function loop() {
    ...
    if(countdown != lastCountDown){
        ...
        if(countdown >0){
            if(countdown <= 10){
                var underTenAudio = new Audio(currentWorkPath + '/resources/'+ countdown.toString() + '.mp3')
                underTenAudio.play();
            } else {         
                boomAudio.play()
            }
    ...
    if(countdown > 0){ 
        ...
        var textData = ctx.measureText(countdown.toString());
        ctx.fillStyle = "rgba("+parseInt(random(155,255))+","+parseInt(random(155,255))+","+parseInt(random(155,255))+",0.5)";
        ctx.fillText(countdown,cw /2-textData.width/2,ch/1.65); 
    } else {
        if(!yeahAudioDone){
            yeahAudio.play() 
        }

        var text1 = "XXXXXXXX祝大家";  
        ctx.font = "100px sans-serif";
        var textData = ctx.measureText(text1);
        ctx.fillStyle = "rgba("+parseInt(random(0,255))+","+parseInt(random(0,255))+","+parseInt(random(0,255))+",0.3)";
        ctx.fillText(text1,cw /2-textData.width/2,ch/2.25); 
        
        var text2 = "新年快乐!";  
        ctx.font = "100px sans-serif";
        textData = ctx.measureText(text2);
        ctx.fillStyle = "rgba("+parseInt(random(0,255))+","+parseInt(random(0,255))+","+parseInt(random(0,255))+",0.3)";
        ctx.fillText(text2,cw /2-textData.width/2,ch/1.65); 
    }
